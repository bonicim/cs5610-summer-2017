...
passport.use(new LocalStrategy(currentStrategy)); // passport will authenticate based on strategy defined by 'currentStrategy'
...
function currentStrategy(username, password, done) {
  userModel
